# -*- coding: utf-8 -*-
"""Copy of IRL-PS-1ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/118EbxxxZ00w3hrAfY9e75U315UV2kAIK
...
documents = open("/content/drive/MyDrive/documents.txt")
...
keywords = open("/content/drive/MyDrive/keywords.txt")
...
def retriever(content, query, top_k):
    # Calculate cosine distance for each document in content
    result = {i: cosine_distance(content[i], query) for i in range(len(content))}

    # Sort the results by cosine distance in descending order and get the top_k indices
    top_indices = sorted(result, key=result.get, reverse=True)[:top_k]
